          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8" style={{ boxShadow: '1px 4px 10px rgba(0.1, 0, 0, 0.2)' }}>
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                {/*
                <input type="text" name="designation" id="designation" placeholder="Employee Designation"
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  value={employeeDetails.designation} onChange={handleChange} required />

                {employeeDetails.designation === 'Other' && (
                  <input type="text" name="newDesignation" id="newDesignation" placeholder="Enter new designation"
                    ...
                    value={employeeDetails.newDesignation} onChange={handleChange} required />
                )}
                */}
